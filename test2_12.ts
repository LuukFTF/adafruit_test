...
let menu4State = false
let menu5State = false
let menu6State = false
...
input.onLoudSound(function () {
    ...
    music.playMelody("A4 A5 A6 C4 C5 C6", 0)
    ...
    if (input.switchRight()) {
        ...
        */
        ...
        while (buttonB2state) {
            ...
            /*
            pins.A2.servoWrite(Math.randomRange(0, 360))
            pause(Math.randomRange(25, 250))
            */

        }
        light.setPixelColor(2, 0x22F00F)
